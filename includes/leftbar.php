<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="images/1623690334803.jpg" alt="LetsGrowMore" height="52" width="52" class="img-circle profile-img">
                                <h6 class="title">LetsGrowMore</h6>
                                <small class="info">Admin Priviledges</small>
                            </div>
                            <!-- /.user-info -->
